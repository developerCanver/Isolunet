...
<div class="br-pagetitle">
    ...
    <div>
        <h4>Comunicaciones - <a class="breadcrumb-item" href="{{ URL::to('/competencia_rendicion') }}">IR
                Comunicaciones</a> </h4>
                <p class="mg-b-0">Editar Rendición de Cuentas</p>
    </div>
</div><!-- d-flex -->
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12 col-lg-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="mecanismo" value="{{$comunicacion->mecanismo}}"
                        required>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-12 col-lg-6">
                <div class="form-group">
                    ...
                    <input type="text" name="frecuencia" class="form-control" value="{{$comunicacion->frecuencia}}"
                        required>
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-12 col-lg-6">
                <div class="form-group">
                    ...
                    <input type="text" name="registro" class="form-control" value="{{$comunicacion->registro}}"
                        required>
                </div>
            </div>
            <div class="col-md-6 col-sm-6 col-xs-12 col-lg-6">
