                ...
                <table class="table">
                    ...
                    <tbody>
                       ...
                       @foreach ($politicas as $politica)
                            ...
                            <td>
                                <a href="{{ URL::action('Planificacion\PoliticaVSObjetivosController@edit',$politica->id_politica_objetivo) }}"><i class="fas fa-pencil-alt fa-2x" style="color:#18A4B4;"></i></a>&nbsp;
                                <a href="{{ URL::action('Planificacion\PoliticaVSObjetivosController@destroy',$politica->id_politica_objetivo) }}" ><i class="fas fa-trash-alt fa-2x" style="color:#C10000;"></i></a>
                            </td>
                        </tr>
                        @endforeach 
