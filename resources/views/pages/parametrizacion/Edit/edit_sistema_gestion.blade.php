        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12 col-lg-6">
                <div class="form-group">
                    <label for="datos">Seleccionar Procesos/Elimina</label>
                    <select name="procesos[]" class="form-control select2"  multiple>
                        @foreach($procesoSelect as $e)
                        <option value="{{ $e->id_proceso }}"
                            {{ $e->sisgestionr_id == $registro->id_sisgestion ? 'selected' : '' }}>
                            {{ $e->nom_proceso }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
			<div class="col-md-6 col-sm-6 col-xs-12 col-lg-6">
                <div class="form-group">
                    <label for="datos">Seleccionar Procesos/Agregar</label>
                    <select name="procesos[]" class="form-control select2"  multiple>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12 col-lg-6">
                <div class="form-group">
                    ...
                    <input type="text" name="nom_sisgestion" class="form-control" value="{{ $registro->str_nombre }}"
                        required>
                </div>
            </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
                <div class="form-group">
                    ...
                    <textarea name="descripcion" class="form-control" rows="5"
                        required>{{ $registro->str_descripcion }}</textarea>
                </div>
            </div>
        </div>
