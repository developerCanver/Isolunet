        ...
        <div class="row">
            <div class="col-md-4 col-sm-4 col-xs-12 col-lg-4">
                <div class="form-group">
                    ...
                    <input type="text" name="variable" class="form-control" required value="{{$planeacion->variable}}">
                </div>
            </div>
            <div class="col-md-4 col-sm-4 col-xs-12 col-lg-4">
                <div class="form-group">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-4 col-xs-12 col-lg-4">
                <div class="form-group">
                    ...
                    <input type="text" name="control" class="form-control" required value="{{$planeacion->control}}">
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-4 col-sm-4 col-xs-12 col-lg-4">
                <div class="form-group">
                    ...
                    <input type="text" name="operacion" class="form-control" required value="{{$planeacion->operacion}}">
                </div>
            </div>
            <div class="col-md-4 col-sm-4 col-xs-12 col-lg-4">
                <div class="form-group">
