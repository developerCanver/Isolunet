...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
            ...
            <a class="nav-item nav-link" href="{{ URL::to('/plantillas') }}">
                <h5><span class="badge badge-info">Plantillas</span></h5>
            </a>
...
<div class="br-pageheader">
    <nav class="breadcrumb pd-0 mg-0 tx-12">
        ...
        <a class="breadcrumb-item" href=""><span class="badge badge-dark">Plantilla</span></a>
                        ...
                        <form action="{{ route('plantillas.update', $consulta->id_plantilla)}}" method="POST"
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
                                    <div class="form-group">
                                        <label><strong>Observaciones:</strong></label>
                                        <textarea name="obs_plantilla"
                                            class="form-control">{{$consulta->obs_plantilla}}</textarea>
                                    </div>
                                </div>
                            </div>
