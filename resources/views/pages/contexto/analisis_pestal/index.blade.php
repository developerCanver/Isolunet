...
<div class="br-pagebody">
    <div class="br-section-wrapper">
        ...
        <br>
        <p>
            <b>Factores Políticos</b>: Información del entorno político que afecte la situación actual o futura de la
            empresa. Por ejemplo, las diferentes políticas del gobierno, la política fiscal de los diferentes países,
            las modificaciones en los tratados comerciales.
        </p>
        <br>
        <p>
            <b>Factores Económicos</b>: Los ciclos económicos, las políticas económicas del gobierno, los tipos de
            interés, los factores macroeconómicos propios de cada país, los tipos de cambio o el nivel de inflación, han
            de ser tenidos en cuenta para la definición de los objetivos económicos de la empresa.
        </p>
        <br>
        <p>
            <b>Factores Socioculturales:</b> Aquellas variables sociales que pueden influir en la empresa. Cambios en
            los gustos o en las modas que repercutan en el nivel de consumo, cambios en el nivel de ingresos o cambios
            en el nivel poblacional.
        </p>
        <br>
        <p>
            <b>Factores Tecnológicos</b>: Un entorno que promulgue la innovación de las TIC, la inversión en I + D y la
            promoción del desarrollo tecnológico llevará a la empresa a integrar dichas variables dentro de su
            estrategia competitiva.
        </p>
        <br>
        <p>
            <b>Factores Ambientales o Ecológicos</b>: Leyes de protección medioambiental, regulación sobre el consumo de
            energía y el reciclaje de residuos, preocupación por el calentamiento global.
        </p>
        <br>
        <p>
            <b>Factores Legales</b>: Licencias, leyes sobre el empleo, derechos de propiedad intelectual, leyes de salud
            y seguridad laboral.
        </p>
        <br>
        <p>
            A través de esta metodología se logró identificar los factores externos e internos que y dar respuesta a
            cada uno de los componentes de la metodología PESTAL:
        </p>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
                <div class="form-group">
                    <label for="datos"><b>1. POLÍTICOS</b><br>
                        ¿Qué factores políticos pueden generar Riesgos y/o Oportunidades adicionales para la
                        implementación o mejora del Sistema de Gestión de Calidad?</label><br>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
                <div class="form-group">
                    <label for="datos"><b>2. ECONÓMICOS</b><br>
                        ¿Qué factores económicos pueden generar Riesgos y/o Oportunidades adicionales para la
                        implementación o mejora del Sistema de Gestión de Calidad?</label><br>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
                <div class="form-group">
                    <label for="datos"><b>3. SOCIALES</b><br>
                        ¿Qué factores sociales pueden generar Riesgos y/o Oportunidades adicionales para la
                        implementación o mejora del Sistema de Gestión de Calidad?</label><br>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
                <div class="form-group">
                    <label for="datos"><b>4. TECNOLÓGICOS</b><br>
                        ¿Qué factores tecnológicos pueden generar Riesgos y/o Oportunidades adicionales para la
                        implementación o mejora del Sistema de Gestión de Calidad?</label><br>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
                <div class="form-group">
                    <label for="datos"><b>5. AMBIENTALES</b><br>
                        ¿Qué factores ambientales pueden generar Riesgos y/o Oportunidades adicionales para la
                        implementación o mejora del Sistema de Gestión de Calidad?</label><br>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
                <div class="form-group">
                    <label for="datos"><b>6. LEGALES</b><br>
                        ¿Qué factores legales pueden generar Riesgos y/o Oportunidades adicionales para la
                        implementación o mejora del Sistema de Gestión de Calidad?</label><br>
