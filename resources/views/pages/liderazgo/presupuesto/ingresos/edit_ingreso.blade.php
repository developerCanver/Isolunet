...
<div class="br-pageheader">
    <nav class="breadcrumb pd-0 mg-0 tx-12">
        ...
        <a class="breadcrumb-item" href=""><span class="badge badge-dark">Editar Ingreso</span></a>
    </nav>
</div><!-- br-pageheader -->
...
<div class="br-pagebody">
  ...
  {{  Form::open(['action' => ['Liderazgo\IngresoController@update',$ingreso->id_ingreso],'autocomplete'=>'off', 'method' => 'POST', 'files' => true]) }}
  {!! Form::token() !!}
  
  
  <div class="row">
    <h4>Ingresos - {{$empresa->razon_social}}</h4>
</div><br>
