...
<div class="br-pageheader">
    <nav class="breadcrumb pd-0 mg-0 tx-12">
        ...
        <a class="breadcrumb-item" href="{{ URL::to('/parm_presupuesto') }}">Apoyo</a>
    ...
    <div class="br-section-wrapper">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12 col-lg-6">
                <div class="form-group">
                    ...
                    <input type="text" name="codigo" class="form-control" required value="{{$informacion->codigo}}">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-3 col-xs-12 col-lg-3">
                <div class="form-group">
                    ...
                    <input type="text" name="version" class="form-control" required value="{{$informacion->version}}">
                </div>
            </div>
            <div class="col-md-3 col-sm-3 col-xs-12 col-lg-3">
                <div class="form-group">
                    <label><strong>Fecha Actualización:</strong></label>
                    <input type="date" name="fecha_info" class="form-control" required value="{{$informacion->fecha_info}}">
                </div>
            </div>
            ...
            <div class="col-md-6 col-sm-6 col-xs-12 col-lg-6">
                <div class="form-group">
                    ...
                    <input type="text" name="lugar_archivo" class="form-control" required value="{{$informacion->lugar_archivo}}">
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-md-3 col-sm-3 col-xs-12 col-lg-3">
                <div class="form-group">
                    <label><strong>Versión:</strong></label>
                    <input type="number" name="version" class="form-control" required value="{{$informacion->version}}">
        ...
        <div class="row">
            <div class="col-md-4 col-sm-4 col-xs-12 col-lg-4">
                <div class="form-group">
                    ...
                    <input type="text" name="organiza" class="form-control" required value="{{$informacion->organiza}}">
                </div>
            </div>
            <div class="col-md-4 col-sm-4 col-xs-12 col-lg-4">
                <div class="form-group">
