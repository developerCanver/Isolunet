...
<div class="br-pagebody">
    <div class="br-section-wrapper">
        ...
        <p>Una vez identificadas las fortalezas, debilidades, oportunidades y amenazas, se identificaron los riesgos y
            oportunidades estratégicas las cuales se describen a continuación:</p>
        <br>
        ...
        <div class="table-responsive">
            <table class="table table-bordered">
                <thead>
                    <tr>
                        <th colspan="2">
                            <center>Descripción del riesgo u oportunidad</center>
                        </th>
                        <th colspan="2">
                ...
                <tbody>
                    <tr>
                        <td colspan="2">
                            <textarea name="riesgo" required id="riesgo" class="form-control" cols="30"
                                rows="3"></textarea>
                        </td>
                        <td colspan="2">
                            <select required name="clasificacion" class="form-control">
                                <option value="" disabled selected>selecionar..</option>
                                <option value="Riesgo estratégico">Riesgo estratégico</option>
                                <option value="Oportunidad estratégica">Oportunidad estratégica</option>
                            </select>
                        </td>
                    </tr>
                </tbody>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a data-toggle="modal" data-target="#myModal-{{ $e->id_riesgos_oportunidades }}"
                                style="color: #00BE31" title="Editar"><i class="fas fa-pencil-alt fa-2x"></i></a>
                            <a data-toggle="modal" data-target="#myModal-delete-{{ $e->id_riesgos_oportunidades }}"
